...
const Navbar = () => {
  ...
  useEffect(() => {
    if (pageYOffset > 500) {
      navHeader.current.classList.add("hidden");
    }else{
      navHeader.current.classList.remove("hidden");
    }
  }, [pageYOffset]);
  ...
  return (
    <div className="header_area " id="header_contents">
      <header className="header-area header-style-1 htype_one">
              ...
              <div className="col-xl-7 col-lg-9 col-md-12 col-sm-12 col-xs-12">
                <div className="top_md d-flex align-items-center">
                  <div className="text workings">
                    <i aria-hidden="false" className="far fa-envelope" />{" "}
                    <span>
                      <a
                        className="text-white"
                        href="mailto:improperties@gmail.com"
                      >
                        improperties@gmail.com
                      </a>{" "}
                    </span>{" "}
                  </div>
                  <div className="call">
                    <a
                      href="tel:+2349088888313"
                  ...
                  <div className="social-icons">
                    <ul className="d-inline-block social-icons-container">
                      <li>
                        <a
                          className="m_icon"
                          href="https://web.facebook.com/improperties.ng"
                        >
                      ...
                      <li>
                        <a
                          className="m_icon"
                          href="https://www.instagram.com/improperties.ng/"
                        >
        ...
        <div
          ref={navHeader}
          className="main_header_content default_header"
